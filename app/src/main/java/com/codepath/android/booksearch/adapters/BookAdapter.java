    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) { // Check if an item was deleted, but the user clicked it before the UI removed it
                ...
                // bookListActivity.launchDetailsActivity(book);
                Intent i = new Intent(mContext, BookDetailActivity.class);

                i.putExtra("book", Parcels.wrap(book)); // using the (String name, Parcelable value) overload!
                mContext.startActivity(i); // dataToSend is now passed to the new Activity
            }
        }
